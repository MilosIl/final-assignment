...
const Navbar = ({
  ...
  return (
    <nav className="flex items-center justify-between w-full px-4 py-2 sticky top-0 z-10 bg-teal-100">
      <Link
        to={"/"}
      ...
      {firstName ? (
        ...
        <>
          <NavbarItem icon={<ToggleThemeContainer />}>Change Theme</NavbarItem>
          <Button>
